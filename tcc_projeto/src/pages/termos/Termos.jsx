            ...
            <Card className={styles.card}>
              <Card.Body>
                ...
                <Card.Text className={styles.text}>
                  ...
                  <strong>assistências técnicas</strong> e{" "}
                  <strong>usuários</strong>.
                  <ul>
                    <li>
                      <strong>Assistências Técnicas</strong>: Empresas ou
                      profissionais que se cadastram para divulgar seus serviços
                      de reparo de dispositivos eletrônicos.
                    </li>
                    <li>
                      <strong>Usuários</strong>: Pessoas físicas que se
                      cadastram para solicitar orçamentos e serviços de
                      manutenção, cadastrando seus dispositivos eletrônicos que
                      necessitam de conserto.
                    </li>
                  </ul>
                  <p>
                    A plataforma atua exclusivamente como um intermediador entre
                    as partes, não realizando os serviços diretamente.
                  </p>
                </Card.Text>
                <Card.Subtitle className={styles.subtitle}>
                ...
                <Card.Text className={styles.text}>
                  <ul>
                    <li>
                      Cada usuário e assistência técnica é responsável pela
                      veracidade das informações fornecidas.
                    </li>
                    <li>
                      A assistência técnica se compromete a fornecer informações
                      precisas sobre seus serviços, prazos, qualificações e
                ...
                <Card.Text className={styles.text}>
                  <ul>
                    <li>
                      Divulgar seus serviços de reparo, manutenção ou
                      diagnóstico.
                    </li>
                    <li>Responder orçamentos e propostas.</li>
                    <li>
                      Cumprir os prazos, valores e condições acordadas
                ...
                <Card.Text className={styles.text}>
                  <ul>
                    <li>
                      Facilitar a conexão entre usuários e assistências
                      técnicas.
                    </li>
                    <li>
                      Disponibilizar ferramentas de cadastro, comunicação e
                      gestão dos pedidos.
                    </li>
                    <li>
                      Não se responsabiliza pela qualidade, execução, prazos ou
                      resultados dos serviços prestados pelas assistências
                      técnicas.
                    </li>
                  </ul>
                </Card.Text>
                ...
                <Card.Text className={styles.text}>
                  <ul>
                    ...
                    <li>
                      Não praticar atos que possam prejudicar a plataforma,
                      outros usuários ou assistências.
                    </li>
                    <li>
                      Respeitar as leis vigentes, especialmente relacionadas a
                      direitos do consumidor, propriedade intelectual,
                ...
                <Card.Text className={styles.text}>
                  ...
                  logotipos, designs e funcionalidades, são protegidos por
                  direitos autorais e de propriedade intelectual. É proibido seu
                  uso não autorizado.
                </Card.Text>
                <Card.Subtitle className={styles.subtitle}>
                ...
                <Card.Text className={styles.text}>
                  A plataforma se reserva o direito de suspender ou cancelar
                  contas que violem estes termos, causem prejuízo a terceiros ou
                  utilizem a plataforma de forma indevida.
                </Card.Text>
                <Card.Subtitle className={styles.subtitle}>
                ...
                <Card.Text className={styles.text}>
                  ...
                  dirimir quaisquer dúvidas ou conflitos oriundos destes Termos,
